...
const index = () => {
  ...
  const addTodo = async () => {
    try {
      ...
      axios
        .post("http://localhost:3000/todos/663b2f50a7575a39edd916d3", todoData) //put ur id from monogdb here after todo in url
        .then((response) => {
  ...
  const getUserTodos = async () => {
    try {
      const response = await axios.get(
        `http://localhost:3000/users/663b2f50a7575a39edd916d3/todos`
      );
